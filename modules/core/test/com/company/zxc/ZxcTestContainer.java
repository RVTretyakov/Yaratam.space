...
public class ZxcTestContainer extends TestContainer {

    public ZxcTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/zxc/app.properties",
    ...
    public static class Common extends ZxcTestContainer {

        public static final ZxcTestContainer.Common INSTANCE = new ZxcTestContainer.Common();
